...
class IOTest extends PHPUnit_Framework_TestCase {
    ...
    public function testFputfw($data, $fieldWidths, $endOfLineDelimiter, $truncateFields, $expected) {
        ...
        foreach ($data as $fields) {
            $numBytes = IO::fputfw($this->handle, $fields, $fieldWidths, $endOfLineDelimiter, $truncateFields);
     ...
     * The idea of this is to ensure that the IO::fputfw function
    ...
    public function testFputfwEolDefault() {
        IO::fputfw($this->handle, array(''), array(0));
    ...
    public function testFputfwThrowsIOEndOfLineSeparatorContainedInLineException($fields, $fieldWidths, $endOfLineSeparator, $message = '') {
        IO::fputfw($this->handle, $fields, $fieldWidths, $endOfLineSeparator);
    }

    public function fputfwThrowsIOEndOfLineSeparatorContainedInLineExceptionProvider() {
        return array(
